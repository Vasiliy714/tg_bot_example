"""Task planner bot entrypoint — same lifecycle as wb_bot."""
...
from task_planner_bot.handlers import register_handlers

logger = get_logger(__name__)
BOT_NAME = "task_planner_bot"
...
async def _run() -> None:
    ...
    bundle = build_bot_bundle(
        token=settings.telegram.task_planner_bot_token.get_secret_value(),
        bot_name=BOT_NAME,
    )
