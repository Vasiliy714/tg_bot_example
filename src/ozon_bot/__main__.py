"""Entrypoint for the Ozon bot. See :mod:`wb_bot.__main__` for the design;
this is the Ozon counterpart with the same lifecycle."""
...
from ozon_bot.handlers import register_handlers
...
async def _run() -> None:
    ...
    bundle = build_bot_bundle(
        token=settings.telegram.ozon_bot_token.get_secret_value(),
        bot_name=BOT_NAME,
    )
